...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoneyTransfer.DAL.Entities.Location", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoneyTransfer.DAL.Entities.Transaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MoneyTransfer.DAL.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MoneyTransfer.DAL.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MoneyTransfer.DAL.Entities.Bank", b =>
                {
                    b.HasOne("MoneyTransfer.DAL.Entities.Location", "Location")
                        .WithMany("Banks")
